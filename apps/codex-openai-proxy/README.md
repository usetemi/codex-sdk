...
Version `0.130.0-11` targets Codex `0.130.0`.

## Run

```bash
npx @usetemi/codex-openai-proxy@0.130.0-11 --api-key local-proxy-token
```
...
docker run --rm -p 8080:8080 \
  ...
  ghcr.io/usetemi/codex-openai-proxy:0.130.0-11
```
