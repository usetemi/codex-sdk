...
```bash
npm install @usetemi/codex-sdk@0.130.0-4
```

Codex OpenAI proxy from npm:

```bash
npx @usetemi/codex-openai-proxy@0.130.0-4 --api-key local-proxy-token
```
...
```bash
go get github.com/usetemi/codex-sdk/packages/go@v0.130.0-4
```
