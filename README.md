...
```bash
npx @usetemi/codex-openai-proxy@0.130.0-9 --api-key local-proxy-token
```
...
```bash
go get github.com/usetemi/codex-sdk/packages/go@v0.130.0-9
```
...
docker run --rm -p 8080:8080 \
  ...
  ghcr.io/usetemi/codex-openai-proxy:0.130.0-9
```
