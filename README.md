...
```bash
npm install @usetemi/codex-sdk@0.133.0
```

Codex OpenAI proxy from npm:

```bash
npx @usetemi/codex-openai-proxy@0.133.0 --api-key local-proxy-token
```
...
```bash
go get github.com/usetemi/codex-sdk/packages/go@v0.133.0
```
...
docker run --rm -p 8080:8080 \
  ...
  ghcr.io/usetemi/codex-openai-proxy:0.133.0
```
