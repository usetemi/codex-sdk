...
```bash
go get github.com/usetemi/codex-sdk/packages/go@v0.130.0-5
```

Package versions track the stable Codex version they target. Version `0.130.0-5` targets Codex `0.130.0`.
